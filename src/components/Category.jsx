...
<div className="relative group">
  ...
  <div className="absolute inset-0 bg-[#1E1E1E] opacity-60 group-hover:opacity-0 transition-opacity duration-300 h-[304px] smartphone:h-[217px] tablet:h-[204px]"></div>
